...
* __TemporalTable:__ Der Interface-Typ TemporalTable ist eine Spezialform der DefTable, die ausschließlich für absolute Zeitdimensionen mit stetig fortlaufenden Werten verwendet werden. Das Interface dieses Typs, das mit finest\_time\_attribute="true" markiert ist wird automatisch für die Historisierungsfunktion herangezogen. Dazu muss das feinste der Zeitattribute mit dem Typ-Parameter __finest\_time\_attribute="true"__ markiert werden und direkt oder indirekt auf die groberen Zeitattribute verweisen. (TODO: in nächster Überarbeitung finest\_time\_attribute in __history\_attribute__ umbenennen, da das aussagekräftiger ist)
...
interface Antrag : FactTable(mandant="true", history="true") {
    ...
    // hier gilt die Annahme, dass wir Tag als finest_time_attribute gekennzeichnet haben
